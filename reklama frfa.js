...
/***/ (function(module, exports) {
    ...
    (function (mamaSorry) {
        ...
        let myHero, myPlayer;
        let ENABLE = Menu.AddToggle([...path, 'Reklama_FRFA'], 'Enable', false)
        ...
        let ENABLE_Kill = Menu.AddToggle([...path, 'Reklama_FRFA'], 'Send when killing', false)
            .SetNameLocale('ru', 'Отправлять при убийстве')
            .OnChange(state => {
            ENABLE_Kill = state.newValue;
        })
            .GetValue();
        let ENABLE_Die = Menu.AddToggle([...path, 'Reklama_FRFA'], 'Send at death', false)
            .SetNameLocale('ru', 'Отправлять при смерти')
            .OnChange(state => {
            ENABLE_Die = state.newValue;
        })
            .GetValue();
        let Bind_AllChat = Menu.AddKeyBind([...path, 'Reklama_FRFA'], 'Bind (All Chat)', Enum.ButtonCode.KEY_NONE).SetNameLocale('ru', 'Бинд (общий чат)');
        let Bind_AllyChat = Menu.AddKeyBind([...path, 'Reklama_FRFA'], 'Bind (Ally Chat)', Enum.ButtonCode.KEY_NONE).SetNameLocale('ru', 'Бинд (союзный чат)');
        Reklama_FRFA.OnUpdate = () => {
            if (!myHero || !ENABLE)
                return;
        ...
        Reklama_FRFA.OnScriptLoad = Reklama_FRFA.OnGameStart = () => {
 ...
 function SendPhrases(allyChat = false, index = null) {
    Chat.Say(allyChat ? 'DOTAChannelType_GameAllies' : 'DOTAChannelType_GameAll', allPhrases[(phraseIndex + 1) % allPhrases.length]);
}
...
let allPhrases = [
  ...
  'ты сможешь наконец-то забыть вкус хуя и выигрывать''
    ...
    /***/ 0:
    /*!*******************************************!*\
      !*** multi ./src/Griefing_Reklama_FRFA.ts ***!
      \*******************************************/
    /*! no static exports found */
    /***/ (function(module, exports, __webpack_require__) {
    
    module.exports = __webpack_require__(/*! ./src/Griefing_Reklama_FRFA.ts */"./src/Griefing_Reklama_FRFA.ts");
